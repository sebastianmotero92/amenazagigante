...
//     players: { [playerId: number]: ExplodingKittensPlayer };
//     tablespeed: string
//     instantaneousMode: boolean
// }
...
// interface Dojo {
//     attr(value: any, arg1: string, arg2: boolean): unknown;
...
//     connect: (element: HTMLElement, event: string, handler: (e) => void) => object;
